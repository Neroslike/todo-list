...
class NewTodoComponent extends _Component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  startingDate(todo, parent) {
    ...
    if (todo) {
      ...
      date = parent ? parent.date : (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(), "yyyy-MM-dd");
    }
    return date;
  }
